...
Note that the first two steps mostly involves the compilation of key information
from the study region and the group of organism included in the assessment.
Although they are the first steps of the workflow, the codes in this this
repository assues that this information was already compiled, estimated or
...
`ConR::criterion_D()`). An specific function was also develop to tell apart NT
...
in the assessments that should evaluated and presented. See the section `Missing
...
submission to the IUCN Red List. This a more technical step of the workflow but
...
functions developed especially for it. The scripts are numbered in the order
